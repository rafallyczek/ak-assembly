...
ODEJM 	 		LXI H,ETYK4 ;odejmowanie  
				...
				CMP E  
				JC WAR2  
				MOV A,H ;wykonaj jeœli SB1 i MB1 > od SB2 i MB2  
				SUB D  
				RST 4  
				MOV A,L  
				SUB E  
...
WAR1 	 		STC  
				...
				MOV A,L  
				CMP E
				JZ WAR3 ;skok jeœli SB1 < SB2 i MB1 = MB2  
				JC WAR3  
				MVI A,'-' ;wykonaj jeœli SB1 < SB2 i MB1 > MB2  
				RST 1  
				MOV A,D  
				SUB H  
				DCR A ; -1 bo po¿yczka  
				...
				RST 4  
				HLT  
WAR2 	 		MOV A,H ;wykonaj jeœli SB1 > SB2 i MB1 < MB2  
				SUB D
				JZ WAR3 ;skok jeœli SB1 = SB2 i MB1 < MB2  
				DCR A ; -1 bo po¿yczka  
				RST 4  
				...
				RST 4  
				HLT  
WAR3 	 		MVI A,'-' ;wykonaj jeœli SB1 < SB2 i MB1 < MB2  
				RST 1  
				MOV A,D  
				SUB H  
				RST 4  
